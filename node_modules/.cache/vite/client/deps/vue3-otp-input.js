...
// node_modules/vue3-otp-input/dist/vue3-otp-input.js
...
var V = { style: { display: "flex", "align-items": "center" } };
var q = ["type", "inputmode", "placeholder", "disabled"];
var z = { key: 0 };
var G = ["innerHTML"];
var U = F({
...
var ne = F({
  ...
  setup(b, { expose: I, emit: i }) {
    ...
    return I({
      ...
      e.inputType === "password" ? (d(), v("input", Q)) : j("", true),
      (d(true), v(W, null, H(e.numInputs, (_, p) => {
        var O, C;
        return d(), S(U, {
          key: p,
          focus: a.value === p,
